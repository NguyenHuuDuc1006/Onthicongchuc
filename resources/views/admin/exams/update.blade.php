                            ...
                            <div class="row">
                                <div class="col-md-9">
                                        ...
                                        @foreach($files as $k=>$file)
                                            <div class="form-group">
                                                <label class="form-label">File {{$k+1}}
                                                    @if($k==0)
                                                        (Tiếng anh:File trắc nghiệm | Kho bạc & thuế: file nào cũng được)
                                                    @elseif($k==1)
                                                        (Tiếng anh:File đoạn văn | Kho bạc & thuế: file nào cũng được)
                                                    @elseif($k==2)
                                                        (Tiếng anh:File điền từ còn thiếu vào đoạn văn | Kho bạc & thuế: file nào
                                                        cũng được)
                                                    @elseif($k==3)
                                                        (Chỉ dành cho file trắc nghiệm về Kho bạc & thuế)
                                                    @endif
                                                </label>
                                    ...
                                    @else
                                        ...
                                        <div class="form-group">
                                            <label class="form-label">File 1 (Tiếng anh:File trắc nghiệm | Kho bạc & thuế: file
                                                nào cũng được)</label>
                                        ...
                                        <div class="form-group">
                                            <label class="form-label">File 2 (Tiếng anh:File đoạn văn | Kho bạc & thuế: file nào
                                                cũng được)</label>
                                        ...
                                        <div class="form-group">
                                            <label class="form-label">File 3 (Tiếng anh:File điền từ còn thiếu vào đoạn
                                                văn | Kho bạc & thuế: file nào cũng được)</label>
                                        ...
                                        <div class="form-group">
                                            <label class="form-label">File 4 (Chỉ dành cho file trắc nghiệm về
                                                Kho bạc & thuế)</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="type" class="form-control">
                                            <option value="3" {{$item->type==3?"selected":''}}>Kiến thức chung kho bạc nhà nước</option>
                                            <option value="2" {{$item->type==2?"selected":''}}>Tiếng anh</option>
                                            <option value="1" {{$item->type==1?"selected":''}}>Kiến thức chung ngành thuế</option>
                                        </select>
                                        @error('type')
                                        <div class="alert alert-warning" role="alert">
