...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <form action="{{route('admin.document.update',$item->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="content" data-default-file="{{asset($item->content)}}"
                                               class="dropify"/>
                                        @error('content')
